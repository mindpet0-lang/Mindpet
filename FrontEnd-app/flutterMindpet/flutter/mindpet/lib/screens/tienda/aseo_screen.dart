...
class _AseoScreenState extends State<AseoScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 222, 243, 253),
      appBar: AppBar(
        title: Text("Aseo       💛 $monedas"),
        backgroundColor: const Color.fromARGB(255, 158, 223, 251),
        actions: [
          Stack(
                  ...
                  final result = await Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) => CarritoScreen(
                        carrito: carrito,
                        categoria: "ASEO", // <--- Aquí defines que es aseo
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: estaEnCarrito
                            ...
                            : const Color.fromARGB(255, 152, 223, 253),
