...
import '../services/puzzle_service5.dart';
import '../widgets/puzzle_tile5.dart';
import '../../../coin_manager.dart';

class PuzzleScreen5 extends StatefulWidget {

  final int userId;
  const PuzzleScreen5({super.key, required this.userId});

  @override
  State<PuzzleScreen5> createState() => _PuzzleScreenState();
}

class _PuzzleScreenState extends State<PuzzleScreen5> {
  final int rows = 4;
  final int cols = 5;
  bool hasStarted = false;

  late List<PuzzlePiece5?> board;
  late List<PuzzlePiece5> shuffledPieces;
  ...
  void startGame() {
  final pieces = PuzzleService5.generatePieces(rows, cols, images);
      ...
      return SizedBox(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return DragTarget<PuzzlePiece5>(
...
SizedBox(
  ...
  child: GridView.builder(
    ...
    itemBuilder: (context, index) {
      ...
      return Draggable<PuzzlePiece5>(
        data: piece,
        feedback: SizedBox(
          width: 60,
          height: 60,
          child: PuzzleTile5(piece: piece),
        ),
        childWhenDragging: Container(
          color: Colors.transparent,
        ),
